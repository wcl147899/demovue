...
export default {
  ...
  methods:{
    ...
    save(){
          ...
          request.put("/campus_put",this.form).then(res => {
          console.log(res)
          if (res.code ==='0'){
    ...
    getDropdown1(){
      request.get("/campus_dropdown1").then(res => {
          console.log("我在下拉框");
          console.log(res);
     ...
     getDropdown2(){
      request.get("/campus_dropdown2").then(res => {
          console.log("我在下拉框");
          console.log(res);
    ...
    submit(){
      request.post("/campus_save",this.form)
      .then(res => {
          let vm=this;
          console.log(res)
          if (res.code ==='0'){
    ...
    handleDelete(id){
      ...
      request.delete("/campus_delete/"+id).then(res =>{//注意delete请求的参数要用+号拼接到路径上，和后台代码是一致的
        let vm=this;
        if (res.code ==='0'){
